from bithub.quantizers import xilinx, fpxmath
...
@pytest.mark.parametrize("q_mode", fpxmath._q_modes)
@pytest.mark.parametrize("o_mode", fpxmath._o_modes)
def test_str_fxpmath_apfixed(nbits, int_bits, q_mode, o_mode):
    ...
    fpxmath_ap_fixed = fpxmath.ap_fixed(nbits, int_bits, q_mode, o_mode)(x)
    fpxmath_ap_fixed = fpxmath.convert(fpxmath_ap_fixed, "string")
...
def test_fxpmath_apfixed(nbits, int_bits, q_mode, o_mode):
    ...
    fpxmath_ap_fixed = fpxmath.ap_fixed(nbits, int_bits, q_mode, o_mode)(x)
    fpxmath_ap_fixed = fpxmath.convert(fpxmath_ap_fixed, "double")
...
def test_fxpmath_apufixed(nbits, int_bits, q_mode, o_mode):
    ...
    fpxmath_ap_ufixed = fpxmath.ap_ufixed(nbits, int_bits, q_mode, o_mode)(xp)
    fpxmath_ap_ufixed = fpxmath.convert(fpxmath_ap_ufixed, "double")
...
def test_fxpmath_apint(nbits):
    ...
    fpxmath_ap_int = fpxmath.ap_int(nbits)(x)
    fpxmath_ap_int = fpxmath.convert(fpxmath_ap_int, "int")
...
def test_fxpmath_apuint(nbits):
    ...
    fpxmath_ap_uint = fpxmath.ap_uint(nbits)(xp)
    fpxmath_ap_uint = fpxmath.convert(fpxmath_ap_uint, "int")
